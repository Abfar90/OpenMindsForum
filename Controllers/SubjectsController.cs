...
namespace OpenMindsForum.Controllers
{
    public class SubjectsController : Controller
    {
        ...
        public SubjectsController(OpenMindsForumContext context)
        {
            _context = context;
        }
        ...
        {
            var openMindsForumContext = _context.Posts.Where(p => p.Subject.SubjectId == model.subjectId);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'OpenMindsForumContext.Subjects'  is null.");
            }
            var subject = await _context.Subjects.FindAsync(id);
            if (subject != null)
            {
